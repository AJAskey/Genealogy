...
In the Genealogy main folder I've created a file called TODO.txt. Generally if I'm away for a while
I'm not really away, but instead of bugging you with stuff I will write it down or
dictate it into this file. Then I will send you the file or tell you to act on that.
It is much more efficient that if I pool up all my requests for an hour or two then try to hit you
every ten seconds with something new.
