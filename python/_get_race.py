...
"""
-----------------------------------
File: _get_race.py  (auto-generated by IpumsCodebookParser.py)

Summary: Data Access Layer for RACE codes.
         Accepts any numeric representation of the code:
         integer or string, with or without leading zeros.
         Key width (4 digits for RACE) is detected
...
_json_path = r"E:/Claude/JSON/race_codes.json"

try:
    with open(_json_path, 'r', encoding='utf-8') as _f:
        _raw = json.load(_f)
    _map = _raw.get("RACE", _raw)
    _width = len(next(iter(_map))) if _map else 1
except FileNotFoundError:
    print(f"WARNING: {_json_path} not found -- RACE lookups will return Unknown")
except Exception as _e:
    print(f"WARNING: could not load RACE codes: {_e}")
...
def get_race(code):
    """
    Returns the description for a RACE code.
...
if __name__ == "__main__":
    print(f"--- Testing RACE Getter (key width = {_width}) ---")
