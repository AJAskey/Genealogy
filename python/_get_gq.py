"""
-----------------------------------
File: _get_gq .py  (auto-generated by IpumsCodebookParser.py)

Summary: Data Access Layer for GQ  codes.
         Accepts any numeric representation of the code:
         integer or string, with or without leading zeros.
         Key width (1 digits for GQ ) is detected
...
_json_path = r"../JSON/gq_codes.json"

try:
    with open(_json_path, 'r', encoding='utf-8') as _f:
        _raw = json.load(_f)
    _map = _raw.get("GQ ", _raw)
    _width = len(next(iter(_map))) if _map else 1
except FileNotFoundError:
    print(f"WARNING: {_json_path} not found -- GQ  lookups will return Unknown")
except Exception as _e:
    print(f"WARNING: could not load GQ  codes: {_e}")
...
def get_gq(code):
    """
    Returns the description for a GQ  code.
...
if __name__ == "__main__":
    print(f"--- Testing GQ  Getter (key width = {_width}) ---")
