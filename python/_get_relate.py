...
"""
-----------------------------------
File: _get_relate.py  (auto-generated by IpumsCodebookParser.py)

Summary: Data Access Layer for RELATE codes.
         Accepts any numeric representation of the code:
         integer or string, with or without leading zeros.
         Key width (4 digits for RELATE) is detected
...
_json_path = r"E:/Claude/JSON/relate_codes.json"

try:
    with open(_json_path, 'r', encoding='utf-8') as _f:
        _raw = json.load(_f)
    _map = _raw.get("RELATE", _raw)
    _width = len(next(iter(_map))) if _map else 1
except FileNotFoundError:
    print(f"WARNING: {_json_path} not found -- RELATE lookups will return Unknown")
except Exception as _e:
    print(f"WARNING: could not load RELATE codes: {_e}")
...
if __name__ == "__main__":
    print(f"--- Testing RELATE Getter (key width = {_width}) ---")
