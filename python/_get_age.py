...
"""
-----------------------------------
File: _get_age.py  (auto-generated by IpumsCodebookParser.py)

Summary: Data Access Layer for AGE codes.
         Accepts any numeric representation of the code:
         integer or string, with or without leading zeros.
         Key width (4 digits for AGE) is detected
...
_json_path = r"E:/Claude/JSON/age_codes.json"

try:
    with open(_json_path, 'r', encoding='utf-8') as _f:
        _raw = json.load(_f)
    _map = _raw.get("AGE", _raw)
    _width = len(next(iter(_map))) if _map else 1
except FileNotFoundError:
    print(f"WARNING: {_json_path} not found -- AGE lookups will return Unknown")
except Exception as _e:
    print(f"WARNING: could not load AGE codes: {_e}")
...
def get_age(code):
    """
    Returns the description for a AGE code.
...
if __name__ == "__main__":
    print(f"--- Testing AGE Getter (key width = {_width}) ---")
