...
"""
-----------------------------------
File: _get_sex.py  (auto-generated by IpumsCodebookParser.py)

Summary: Data Access Layer for SEX codes.
         Accepts any numeric representation of the code:
         integer or string, with or without leading zeros.
         Key width (4 digits for SEX) is detected
...
_json_path = r"E:/Claude/JSON/sex_codes.json"

try:
    with open(_json_path, 'r', encoding='utf-8') as _f:
        _raw = json.load(_f)
    _map = _raw.get("SEX", _raw)
    _width = len(next(iter(_map))) if _map else 1
except FileNotFoundError:
    print(f"WARNING: {_json_path} not found -- SEX lookups will return Unknown")
except Exception as _e:
    print(f"WARNING: could not load SEX codes: {_e}")
...
def get_sex(code):
    """
    Returns the description for a SEX code.
...
if __name__ == "__main__":
    print(f"--- Testing SEX Getter (key width = {_width}) ---")
