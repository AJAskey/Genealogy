...
"""
-----------------------------------
File: _get_bpl.py  (auto-generated by IpumsCodebookParser.py)

Summary: Data Access Layer for BPL codes.
         Accepts any numeric representation of the code:
         integer or string, with or without leading zeros.
         Key width (4 digits for BPL) is detected
...
_json_path = r"E:/Claude/JSON/bpl_codes.json"

try:
    with open(_json_path, 'r', encoding='utf-8') as _f:
        _raw = json.load(_f)
    _map = _raw.get("BPL", _raw)
    _width = len(next(iter(_map))) if _map else 1
except FileNotFoundError:
    print(f"WARNING: {_json_path} not found -- BPL lookups will return Unknown")
except Exception as _e:
    print(f"WARNING: could not load BPL codes: {_e}")
...
def get_bpl(code):
    """
    Returns the description for a BPL code.
...
if __name__ == "__main__":
    print(f"--- Testing BPL Getter (key width = {_width}) ---")
